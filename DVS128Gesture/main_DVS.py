...
if __name__ == '__main__':
    ...
    dataset_dir = r"/usr/common/datasets/" + dataset_name
    ...
    dir_name = f'{dataset_name}_init_tau_{init_tau}_use_max_pool_{use_max_pool}_T_{T}_detach_reset_{detach_reset}'
    ...
    train_data_loader = torch.utils.data.DataLoader(
        dataset=DVS128Gesture(dataset_dir, train=True, data_type='frame', frames_number=T,
                              split_by=split_by),
    ...
    test_data_loader = torch.utils.data.DataLoader(
        dataset=DVS128Gesture(dataset_dir, train=False, data_type='frame', frames_number=T,
                              split_by=split_by),
        batch_size=batch_size,
        shuffle=False,
        num_workers=4,
    ...
    if os.path.exists(check_point_path):
        ...
        net = SpikingCNN.DVS128GestureNet(T=T, init_tau=init_tau, use_max_pool=use_max_pool,
